    ...
    return (
        <div style={{ backgroundImage: "url('./images/home-banner.jpg')" }} className=" w-full min-h-[200px]  lg:min-h-[350px] bg-no-repeat bg-cover">
            <div className="grid grid-cols-3 text-slate-900">
                <div className="col-span-2 px-[40px] py-[20px] lg:px-[100px] lg:py-[40px] flex flex-col justify-center sm:justify-center md:justify-start items-center  gap-4">
                    <div className="flex flex-col gap-1">
                        <div className="text-3xl md:text-4xl  lg:text-6xl  font-semibold">Rotex</div>
                        <div className="text-xl md:text-2xl lg:text-4xl font-medium">Automation Valves</div>
                    </div>
                    <div className="flex flex-col gap-1">
                        <div className="flex gap-2 items-center text-sm md:text-md lg:text-lg font-base">
                            <FiCheckCircle color="" />
