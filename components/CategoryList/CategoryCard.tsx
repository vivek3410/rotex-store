...
export const CategoryCard = ({ data }: CategoryCardProps) => {
    ...
    return (
        <div className="flex flex-col gap-1 border-slate-200 border-2 w-full min-h-[200px] max-h-[400px] p-2 md:p-4 rounded-md cursor-pointer" onClick={() => router.push(`/product-category/${data.categoryId}`)}>
